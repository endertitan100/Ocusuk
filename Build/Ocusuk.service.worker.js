...
/** @type {string} */
const OFFLINE_URL = 'Ocusuk.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Ocusuk.html","Ocusuk.js","Ocusuk.offline.html","Ocusuk.icon.png","Ocusuk.apple-touch-icon.png","Ocusuk.worker.js","Ocusuk.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Ocusuk.wasm","Ocusuk.pck"];
